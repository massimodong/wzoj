...
return [
    ...
    'settings'      => [
        'default' => [
            ...
            'CSS.AllowedProperties'    => 'font-weight,font-style,text-decoration,padding-left,color,background-color,text-align,margin-left,margin-right,height,width,border-color',
