...
class InitSidebarsAndDiyPages extends Migration
{
    ...
    public function up()
    {
	    $faq_content = '<h1 class="text-center" style="text-align: center;">FAQ:</h1>
		    ...
		    <td style="padding: 0 6px;">gcc Main.c -o Main -fno-asm -Wall -lm --static -std=c99 -DONLINE_JUDGE</td>
		    </tr>
		    <tr>
		    <td style="padding: 0 6px;">C++</td>
		    <td style="padding: 0 6px;">g++ Main.cc -o Main -fno-asm -Wall -lm --static -std=c++0x -DONLINE_JUDGE</td>
		    </tr>
		    <tr>
		    <td style="padding: 0 6px;">Pascal</td>
		    <td style="padding: 0 6px;">fpc Main.pas -Cs32000000 -Sh -O2 -Co -Ct -Ci</td>
		    </tr>
		    <tr>
		    <td style="padding: 0 6px;">Python</td>
		    <td style="padding: 0 6px;">python3.* Main.py</td>
		    </tr>
		    </tbody>
		    </table>
		    <h3>如何自定义头像?</h3>
